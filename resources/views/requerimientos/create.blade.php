...
<div class="card" style="max-width: 800px; margin: 0 auto;">
    ...
    <p>
        ...
        El requerimiento quedará registrado con estado inicial
    ...
    >
        ...
        >
            ...
            <option
                value="computador"
                {{ old('categoria') === 'computador' ? 'selected' : '' }}
            >
                Computador
            </option>
            ...
            <option
                value="internet"
                {{ old('categoria') === 'internet' ? 'selected' : '' }}
            >
                Internet / Red
            </option>
            ...
            <option
                value="impresora"
                {{ old('categoria') === 'impresora' ? 'selected' : '' }}
            >
                Impresora
            </option>
            ...
            <option
                value="sistema"
                {{ old('categoria') === 'sistema' ? 'selected' : '' }}
            >
                Sistema municipal
            </option>
            ...
            <option
                value="usuario"
                {{ old('categoria') === 'usuario' ? 'selected' : '' }}
            >
